...
define("component/display/Filter", ["require", "exports", "component/core/Button", "component/core/DisplaySlot", "kitsui", "kitsui/component/Popover", "kitsui/component/Slot", "kitsui/utility/Arrays", "kitsui/utility/InputBus", "kitsui/utility/Mouse", "kitsui/utility/Task", "utility/Text"], function (require, exports, Button_1, DisplaySlot_1, kitsui_9, Popover_1, Slot_2, Arrays_2, InputBus_1, Mouse_1, Task_1, Text_1) {
    ...
    const Filter = Object.assign((0, kitsui_9.Component)((component) => {
        ...
        const filterText = (0, kitsui_9.State)(filterFromParam ?? '');
        ...
        const appliedFilters = filters.mapManual(filters => filters.filter(filter => filter.id !== 'plaintext' || (config.value?.plaintextFilterIsValid ?? exports.PLAINTEXT_FILTER_IS_VALID)(filter.token)));
...
define("component/core/Image", ["require", "exports", "kitsui", "kitsui/utility/Task"], function (require, exports, kitsui_10, Task_2) {
    ...
    exports.default = (0, kitsui_10.Component)('img', (component, src, fallback) => {
        ...
        const state = (0, kitsui_10.State)(undefined);
        const dimensions = (0, kitsui_10.State)(undefined);
    ...
    const Navbar = (0, kitsui_18.Component)('nav', (component) => {
        ...
        return component.style('navbar')
            ...
            overrideHomeLink(route, owner) {
                homeLinkState.bind(owner, kitsui_18.State.get(route));
...
define("component/core/TabButton", ["require", "exports", "component/core/Button", "kitsui"], function (require, exports, Button_6, kitsui_37) {
    ...
    const TabButton = (0, kitsui_37.Component)((component, active) => {
        const displayMode = (0, kitsui_37.State)('horizontal');
...
define("component/core/Tabinator", ["require", "exports", "component/core/Link", "component/core/TabButton", "kitsui"], function (require, exports, Link_2, TabButton_1, kitsui_38) {
    ...
    const Tabinator = (0, kitsui_38.Component)((component) => {
        ...
        let Tab;
        const displayMode = (0, kitsui_38.State)('horizontal');
        const hideWhenSingleTab = (0, kitsui_38.State)(false);
        const isSingleTab = kitsui_38.State.JIT(() => !!Tab && [...tabsWrapper.getChildren(Tab)].length <= 1);
        const header = (0, kitsui_38.Component)()
            .style('tabinator-header')
            .style.bind(displayMode.equals('vertical'), 'tabinator-header--vertical')
            .style.bind(kitsui_38.State.Every(component, hideWhenSingleTab, isSingleTab), 'tabinator-header--hidden')
            .appendTo(component);
        const tabsWrapper = (0, kitsui_38.Component)()
        ...
        Tab = (0, kitsui_38.Component)((component, route) => {
...
define("component/overlay/DataOverlay", ["require", "exports", "component/core/Details", "component/core/DisplaySlot", "component/core/Image", "component/core/Link", "component/core/Paginator", "component/core/Tabinator", "component/view/data/DataDefinitionButton", "component/view/data/DataHelper", "component/view/data/DataProvider", "kitsui", "kitsui/component/Loading", "kitsui/component/Slot", "kitsui/utility/InputBus", "kitsui/utility/Task", "utility/Arrays"], function (require, exports, Details_2, DisplaySlot_5, Image_9, Link_3, Paginator_1, Tabinator_1, DataDefinitionButton_1, DataHelper_2, DataProvider_1, kitsui_41, Loading_3, Slot_7, InputBus_3, Task_4, Arrays_5) {
    ...
    exports.default = (0, kitsui_41.Component)((component, params) => {
        ...
        const JSONRender = (0, kitsui_41.Component)((component, value, links) => {
            links ??= (0, kitsui_41.State)(undefined);
            ////////////////////////////////////
            //#region JSON
            ...
            ////////////////////////////////////
            //#region Copypaste
            const JSONCopyPaste = (0, kitsui_41.Component)((component, value) => component.and(JSONComponent)
                ...
                if (document.activeElement !== input.element) {
                    void Task_4.default.yield().then(() => {
            ...
            const JSONContainer = (0, kitsui_41.Component)((component, key, value, path, holdIn, isSoloKey = false) => {
                ...
                const hold = (0, kitsui_41.State)(false);
                if (holdIn)
            ...
            const JSONCascade = (array, path, hold, init) => {
                ...
                const result = (0, kitsui_41.Component)();
                if (chunks.length === 1) {
                ...
                function cascadeChunk(chunk) {
                    ...
                    return (0, kitsui_41.Component)()
                        ...
                        const expandable = (0, kitsui_41.Component)()
                            .style('data-overlay-json-container-expandable')
                            .appendTo(details.content);
                        const openedOnce = (0, kitsui_41.State)(false);
                        kitsui_41.State.Every(details, details.open, openedOnce.falsy).use(details, open => {
                            if (!open)
                                return;
            ...
            ////////////////////////////////////
            //#region Literals
            const JSONString = (0, kitsui_41.Component)((component, string) => component.and(JSONComponent)
            ...
            const JSONImage = (0, kitsui_41.Component)((component, url) => component.and(JSONComponent)
            ...
            ////////////////////////////////////
            //#region Links
            const JSONLinks = (0, kitsui_41.Component)((component, key, path, leadingSpace = ' ') => component.and(DisplaySlot_5.default).use(links, (slot, links) => {
                if (!links)
                    return;
                const pathString = path?.join('.') ?? '';
...
define("component/view/DataView", ["require", "exports", "component/core/Button", "component/core/Details", "component/core/DisplaySlot", "component/core/Link", "component/core/Paginator", "component/core/TabButton", "component/core/View", "component/display/Filter", "component/DisplayBar", "component/Overlay", "component/overlay/DataOverlay", "component/view/data/DataDefinitionButton", "component/view/data/DataHelper", "component/view/data/DataProvider", "kitsui", "kitsui/component/Loading", "kitsui/component/Slot", "kitsui/utility/Arrays", "kitsui/utility/Functions", "lang", "Relic", "utility/Async", "utility/Objects", "utility/Time"], function (require, exports, Button_8, Details_3, DisplaySlot_6, Link_4, Paginator_2, TabButton_2, View_2, Filter_4, DisplayBar_3, Overlay_3, DataOverlay_1, DataDefinitionButton_2, DataHelper_3, DataProvider_2, kitsui_42, Loading_4, Slot_8, Arrays_6, Functions_1, lang_2, Relic_8, Async_1, Objects_4, Time_2) {
        ...
        filterConfig: {
            ...
            plaintextFilterTweakChip(chip, token) {
                if (token.lowercase.startsWith('deep:'))
                    token = Filter_4.FilterToken.create(token.slice(5));
                (0, Filter_4.PLAINTEXT_FILTER_TWEAK_CHIP)(chip, token);
            },
    ...
    const currentTime = (0, kitsui_42.State)(Date.now());
    ...
    exports.default = (0, View_2.default)(async (view) => {
        ...
        const lastCheck = (0, kitsui_42.State)(undefined);
        const state = kitsui_42.State.Async(view, async () => {
        ...
        if (signal.aborted)
            return;
        const componentNames = kitsui_42.State.Async(view, () => conduit.getComponentNames());
        const links = kitsui_42.State.Async(view, () => conduit.definitions.en.DeepsightLinksDefinition.all());
        ...
        (0, Loading_4.default)()
            ...
            (0, kitsui_42.Component)()
                ...
                .append((0, kitsui_42.Component)().style('data-view-versions-text-provider').text.set(quilt => quilt['view/data/versions/label']()), (0, kitsui_42.Component)().style('data-view-versions-text-punctuation').text.set(': '))
                .append(...Object.entries(simplified)
                .filter(([, version]) => version)
                .flatMap(([provider, version], i) => [
                i && (0, kitsui_42.Component)().style('data-view-versions-text-punctuation').text.set(' / '),
                (0, kitsui_42.Component)().style('data-view-versions-text-version').text.set(version),
            ])
                .filter(Arrays_6.Truthy))
            ...
            (0, kitsui_42.Component)()
                ...
                .flatMap(([provider, version], i) => [
                i && (0, kitsui_42.Component)().style('data-view-versions-text-punctuation').text.set(' / '),
                (0, kitsui_42.Component)().style('data-view-versions-text-provider').text.set(provider),
                (0, kitsui_42.Component)().style('data-view-versions-text-punctuation').text.set(': '),
                (0, kitsui_42.Component)().style('data-view-versions-text-version').text.set(version),
            ])
                .filter(Arrays_6.Truthy))
            ...
            (0, kitsui_42.Component)()
                ...
                .tweak(button => button
                .text.bind(kitsui_42.State.Map(slot, [currentTime, lastCheck, button.hoveredOrHasFocused], (elapsed, last, hovered) => quilt => quilt['view/data/versions/action/check'](!last || !hovered ? undefined : Time_2.default.relative(last, { components: 1 })))))
        ...
        (0, Slot_8.default)()
            ...
            for (let i = 0; i < componentNames.length; i++) {
                ...
                details.summary
                    ...
                    .append(augments && (0, kitsui_42.Component)()
            ...
            for (const wrapper of groupWrappers.values()) {
                const filteredIn = kitsui_42.State.Map(wrapper.details, wrapper.filteredInStates, (...states) => states.some(v => v));
        ...
        const overlayDefinition = kitsui_42.State.Async(view, view.params, async (params, signal, setProgress) => {
            ...
            const result = params.hash !== 'full'
                ...
                : kitsui_42.State.Async(kitsui_42.State.Owner.fromSignal(signal), async () => {
                    const conduit = await Relic_8.default.connected;
                    if (signal.aborted)
                        return undefined;
        ...
        const shouldShowOverlay = kitsui_42.State.Some(view, overlayDefinition.truthy, hasPendingOverlayDefinition);
...
define("index", ["require", "exports", "component/Kit", "kitsui", "kitsui/utility/ActiveListener", "kitsui/utility/FocusListener", "kitsui/utility/HoverListener", "kitsui/utility/Mouse", "kitsui/utility/Viewport", "model/Profile", "navigation/Navigate", "Relic", "utility/Arrays", "utility/DevServer", "utility/Env", "utility/Text"], function (require, exports, Kit_1, kitsui_46, ActiveListener_1, FocusListener_1, HoverListener_1, Mouse_2, Viewport_1, Profile_3, Navigate_1, Relic_10, Arrays_7, DevServer_1, Env_4, Text_2) {
    ...
    Arrays_7.default.applyPrototypes();
