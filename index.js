...
define("component/display/filter/FilterElement", ["require", "exports", "component/display/Filter", "kitsui", "Relic"], function (require, exports, Filter_3, kitsui_20, Relic_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Filter_3 = __importDefault(Filter_3);
    Relic_3 = __importDefault(Relic_3);
    const DestinyDamageTypeDefinition = kitsui_20.State.Async(kitsui_20.State.Owner.create(), async (signal, setProgress) => {
...
define("component/display/filter/FilterRarity", ["require", "exports", "component/display/Filter", "kitsui", "Relic"], function (require, exports, Filter_4, kitsui_21, Relic_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Filter_4 = __importDefault(Filter_4);
    Relic_4 = __importDefault(Relic_4);
    const DeepsightTierTypeDefinition = kitsui_21.State.Async(kitsui_21.State.Owner.create(), async (signal, setProgress) => {
        const conduit = await Relic_4.default.connected;
        return await conduit.definitions.en.DeepsightTierTypeDefinition.all();
    });
    const EngramIcon = kitsui_21.State.Async(kitsui_21.State.Owner.create(), async (signal, setProgress) => {
        const conduit = await Relic_4.default.connected;
...
define("component/display/filter/FilterWeaponFoundry", ["require", "exports", "component/display/Filter", "kitsui", "model/DisplayProperties", "Relic"], function (require, exports, Filter_5, kitsui_22, DisplayProperties_1, Relic_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Filter_5 = __importDefault(Filter_5);
    DisplayProperties_1 = __importDefault(DisplayProperties_1);
    Relic_5 = __importDefault(Relic_5);
    const DeepsightWeaponFoundryDefinition = kitsui_22.State.Async(kitsui_22.State.Owner.create(), async (signal, setProgress) => {
    ...
    exports.default = Filter_5.default.Definition({
        ...
        match(owner, token) {
            ...
            return {
                ...
                icon: {
                    image: foundry.map(owner, def => def && DisplayProperties_1.default.icon(def.displayProperties.icon)),
                    tweak: image => (image
...
define("component/display/filter/FilterWeaponType", ["require", "exports", "component/display/Filter", "kitsui", "Relic"], function (require, exports, Filter_6, kitsui_23, Relic_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Filter_6 = __importDefault(Filter_6);
    Relic_6 = __importDefault(Relic_6);
    const DeepsightWeaponTypeDefinition = kitsui_23.State.Async(kitsui_23.State.Owner.create(), async (signal, setProgress) => {
    ...
    exports.default = Object.assign(Filter_6.default.Definition({
        id: 'type',
        type: 'or',
        collapsed: {
...
define("component/display/filter/FilterWeaponFrame", ["require", "exports", "component/display/Filter", "component/display/filter/FilterWeaponType", "kitsui", "kitsui/utility/Arrays", "Relic"], function (require, exports, Filter_7, FilterWeaponType_1, kitsui_24, Arrays_4, Relic_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Filter_7 = __importDefault(Filter_7);
    FilterWeaponType_1 = __importDefault(FilterWeaponType_1);
    Relic_7 = __importDefault(Relic_7);
    const DeepsightWeaponFrameDefinition = kitsui_24.State.Async(kitsui_24.State.Owner.create(), async (signal, setProgress) => {
...
define("component/core/Paragraph", ["require", "exports", "kitsui"], function (require, exports, kitsui_25) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_25.Component)(component => {
        return component.style('paragraph');
    });
});
define("component/core/Lore", ["require", "exports", "component/core/Paragraph", "kitsui"], function (require, exports, Paragraph_1, kitsui_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Paragraph_1 = __importDefault(Paragraph_1);
    exports.default = (0, kitsui_26.Component)(component => component.and(Paragraph_1.default).style('lore'));
});
define("component/item/Power", ["require", "exports", "kitsui", "Relic"], function (require, exports, kitsui_27, Relic_8) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Relic_8 = __importDefault(Relic_8);
    const prismaticIcon = kitsui_27.State.Async(kitsui_27.State.Owner.create(), async (signal, setProgress) => {
    ...
    exports.default = (0, kitsui_27.Component)((component, power, collections) => {
        collections = kitsui_27.State.get(collections);
        component.style('power');
        // eslint-disable-next-line @typescript-eslint/no-non-null-asserted-optional-chain
        const primaryDamageType = kitsui_27.State.Map(component, [power, collections], (power, collections) => collections.damageTypes[power?.damageTypes?.[0]]);
        ...
        (0, kitsui_27.Component)()
            ...
            kitsui_27.State.Use(wrapper, { primaryDamageType, damageTypes, prismaticIcon }).use(wrapper, ({ damageTypes, prismaticIcon }) => {
                ...
                if (damageTypes?.length === 5) {
                    ...
                    (0, kitsui_27.Component)()
                        ...
                        .appendTo(wrapper);
                    const gradientFixer = (0, kitsui_27.Component)()
...
define("component/item/Stats", ["require", "exports", "kitsui"], function (require, exports, kitsui_28) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Stats = (0, kitsui_28.Component)((component, item, collections, display) => {
        item = kitsui_28.State.get(item);
        collections = kitsui_28.State.get(collections);
        component.style('stats');
        const statsVisible = (0, kitsui_28.State)(false);
        const hasStats = (0, kitsui_28.State)(false);
        const isAbbreviated = (0, kitsui_28.State)(false);
        kitsui_28.State.Use(component, { item, collections, isAbbreviated }, ({ item, collections, isAbbreviated }) => {
            component.removeContents();
            let _barStatsWrapper;
            let _numericStatsWrapper;
            const barStatsWrapper = () => _barStatsWrapper ??= (0, kitsui_28.Component)().style('stats-section').tweak(display?.tweakStatSection).prependTo(component);
            const numericStatsWrapper = () => _numericStatsWrapper ??= (0, kitsui_28.Component)().style('stats-section').tweak(display?.tweakStatSection).appendTo(component);
            // eslint-disable-next-line @typescript-eslint/no-non-null-asserted-optional-chain
            ...
            for (const stat of stats) {
                ...
                (0, kitsui_28.Component)()
                    .style('stats-stat')
                    .append((0, kitsui_28.Component)()
                    .style('stats-stat-label')
                    .text.set(statName)
                    .tweak(display?.tweakStatLabel, def, stat))
                    .append(!stat.displayAsNumeric && (0, kitsui_28.Component)()
...
define("model/ArmourSet", ["require", "exports", "kitsui"], function (require, exports, kitsui_29) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = ArmourSet;
    function ArmourSet(owner, item, collections) {
        collections = kitsui_29.State.get(collections);
        return kitsui_29.State.Map(owner, [item, collections], (item, collections) => {
...
define("utility/TooltipManager", ["require", "exports", "kitsui"], function (require, exports, kitsui_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function TooltipManager(componentBuilder, definition) {
        ...
        const result = {
            apply(component, ...params) {
                ...
                kitsui_30.State.Use(component, { focused: componentWithPopover.hoveredOrHasFocused, visible: componentWithPopover.popover.visible }).subscribe(component, ({ focused, visible }, { visible: oldVisible } = { focused: false, visible: false }) => {
...
define("component/tooltip/ItemTooltip", ["require", "exports", "component/core/DisplaySlot", "component/core/Image", "component/core/Lore", "component/core/Paragraph", "component/item/Power", "component/item/Stats", "kitsui", "kitsui/component/Slot", "kitsui/component/Tooltip", "model/ArmourSet", "model/DisplayProperties", "utility/Categorisation", "utility/Objects", "utility/TooltipManager"], function (require, exports, DisplaySlot_2, Image_2, Lore_1, Paragraph_2, Power_1, Stats_1, kitsui_31, Slot_4, Tooltip_1, ArmourSet_1, DisplayProperties_2, Categorisation_1, Objects_1, TooltipManager_1) {
    ...
    const ItemTooltip = (0, kitsui_31.Component)((component, item, collections) => {
        ...
        ////////////////////////////////////
        //#region Watermark
        const moment = kitsui_31.State.Map(tooltip, [collections, item], (collections, item) => collections.moments.find(moment => moment.moment.hash === item.momentHash));
        ...
        (0, kitsui_31.Component)()
            ...
            .style.bindVariable('item-watermark', moment.map(tooltip, moment => moment && `url(${DisplayProperties_2.default.icon(moment.moment.iconWatermark)}`))
            .appendTo(tooltip.header);
        ...
        ////////////////////////////////////
        //#region Primary Info
        const primaryInfo = (0, kitsui_31.Component)()
            .style('item-tooltip-primary-info')
            .appendTo(tooltip.body);
        ////////////////////////////////////
        //#region Damage
        (0, Power_1.default)(kitsui_31.State.Use(primaryInfo, { damageTypes: item.map(primaryInfo, item => item.damageTypeHashes) }), collections)
        ...
        const ammo = kitsui_31.State.Map(tooltip, [item, collections], (item, collections) => collections.ammoTypes[item.ammoType]);
        const archetype = kitsui_31.State.Map(tooltip, [item, collections], (item, collections) => {
        ...
        const secondaryType = kitsui_31.State.Map(tooltip, [archetype, ammo], (archetype, ammo) => {
        ...
        (0, kitsui_31.Component)()
            ...
            .tweak(wrapper => {
            (0, Slot_4.default)().appendTo(wrapper).use(kitsui_31.State.Use(wrapper, { sockets: perks, itemSet, isCollections, collections }), (slot, { sockets, itemSet, isCollections, collections }) => {
                ////////////////////////////////////
                //#region Socket component
                const Plugs = (socket) => socket.plugs
                    .map(plugHash => collections.plugs[plugHash])
                    .filter(plug => !!plug);
                const Socket = (0, kitsui_31.Component)((wrapper, socket, plugs, noSocketed) => {
                    ...
                    if (!socketed?.displayProperties.name && !isCollectionsRoll && !noSocketed)
                        return;
                    if (socketed) {
                        (0, Image_2.default)(`https://www.bungie.net${socketed.displayProperties.icon}`)
                    ...
                    for (const plug of additionalPlugs)
                        (0, Image_2.default)(`https://www.bungie.net${plug.displayProperties.icon}`)
                            .style('item-tooltip-perks-perk-icon')
                            .appendTo(wrapper);
                    return wrapper;
                });
                ...
                if (exoticCatalyst && (isCollections || false)) {
                    ...
                    for (const perk of perks) {
                        (0, kitsui_31.Component)()
                            ...
                            .append((0, Image_2.default)(`https://www.bungie.net${perk.displayProperties.icon}`)
                            .style('item-tooltip-perks-perk-icon'))
                            .append((0, kitsui_31.Component)()
                            .style('item-tooltip-perks-perk-label')
                ...
                if (itemSet) {
                    (0, kitsui_31.Component)()
                        ...
                        .append(...itemSet.perks.map(perk => (0, Image_2.default)(`https://www.bungie.net${perk.definition.displayProperties.icon}`)
                        .style('item-tooltip-perks-perk-icon')))
                        .appendTo(slot);
                }
                //#endregion
        ...
        sourceList.use({ item, collections }, (slot, { item, collections }) => {
            ...
            if (!sources?.length)
                return;
            const SourceWrapper = (0, kitsui_31.Component)((component, display) => {
                const icon = !display.icon ? undefined
                    : (0, Image_2.default)(`https://www.bungie.net${display.icon}`).style('item-tooltip-source-icon');
                const title = (0, kitsui_31.Component)()
                    .style('item-tooltip-source-title')
                    .text.set(display.name);
                const subtitle = !display.subtitle ? undefined : (0, kitsui_31.Component)()
        ...
        (0, kitsui_31.Component)()
            ...
            for (const perk of itemSet.perks)
                (0, kitsui_31.Component)()
                    ...
                    .append((0, Image_2.default)(`https://www.bungie.net${perk.definition.displayProperties.icon}`)
        ...
        //#endregion
        ////////////////////////////////////
        kitsui_31.State.Use(tooltip, { item, collections }, () => tooltip.rect.markDirty());
        return tooltip;
    });
    exports.default = (0, TooltipManager_1.default)(ItemTooltip, {
        ...
        build(states, tooltip, item, collections) {
            item = kitsui_31.State.get(item);
            collections = kitsui_31.State.get(collections);
            return tooltip.and(ItemTooltip, states.item ??= kitsui_31.State.Mutable(tooltip, item), states.collections ??= kitsui_31.State.Mutable(tooltip, collections));
        },
        onHover(states, item, collections) {
            item = kitsui_31.State.value(item);
            console.log(item.displayProperties.name, item);
        },
    });
});
define("component/item/Item", ["require", "exports", "component/core/Button", "component/core/Image", "component/tooltip/ItemTooltip", "kitsui", "model/DisplayProperties"], function (require, exports, Button_4, Image_3, ItemTooltip_1, kitsui_32, DisplayProperties_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Item = Object.assign((0, kitsui_32.Component)((component, item, collections) => {
        item = kitsui_32.State.get(item);
        collections = kitsui_32.State.get(collections);
        ...
        (0, kitsui_32.Component)()
            ...
            .append((0, Image_3.default)(item.map(component, item => `https://www.bungie.net${item.displayProperties.icon}`))
            .style('item-image'))
            .appendTo(component);
        const moment = kitsui_32.State.Map(component, [collections, item], (collections, item) => collections.moments.find(moment => moment.moment.hash === item.momentHash));
        (0, kitsui_32.Component)()
            .style('item-watermark')
            .style.bind(featured, 'item-watermark--featured')
            .style.bindVariable('item-watermark', moment.map(component, moment => moment && `url(${DisplayProperties_3.default.icon(moment.moment.iconWatermark)}`))
            .appendTo(component);
        (0, kitsui_32.Component)()
...
define("component/tooltip/GenericTooltip", ["require", "exports", "kitsui", "kitsui/component/Tooltip", "utility/TooltipManager"], function (require, exports, kitsui_33, Tooltip_2, TooltipManager_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Tooltip_2 = __importDefault(Tooltip_2);
    TooltipManager_2 = __importDefault(TooltipManager_2);
    const GenericTooltipBuilder = (0, kitsui_33.Component)((component) => {
        ...
        const description = (0, kitsui_33.Component)()
    ...
    const GenericTooltip = (0, TooltipManager_2.default)(GenericTooltipBuilder, {
        ...
        build(states, tooltip, applicator) {
            return tooltip.and(GenericTooltipBuilder).tweak(tooltip => {
                states.applicator ??= (0, kitsui_33.State)(applicator);
...
define("component/tooltip/PlugTooltip", ["require", "exports", "component/core/DisplaySlot", "component/core/Icon", "component/core/Image", "component/item/Stats", "kitsui", "kitsui/component/Tooltip", "style/icons", "utility/TooltipManager"], function (require, exports, DisplaySlot_3, Icon_2, Image_4, Stats_2, kitsui_34, Tooltip_3, icons_2, TooltipManager_3) {
    ...
    const PlugTooltip = (0, kitsui_34.Component)((component, plug, collections) => {
        ...
        (0, DisplaySlot_3.default)().style('plug-tooltip-clarity').appendToWhen(clarity.truthy, tooltip.body).use(clarity, (slot, clarity) => {
            ...
            (0, kitsui_34.Component)()
                ...
                .append((0, Image_4.default)('https://avatars.githubusercontent.com/u/117947315?s=48&v=4').style('plug-tooltip-clarity-header-icon'))
                .append((0, kitsui_34.Component)().style('plug-tooltip-clarity-header-name').text.set('Clarity'))
            ...
            const clarityComponents = {
                ...
                labelledLine: (component, data, { siblings }, previousData = previousSibling(siblings, data)) => (component
                    ...
                    .append((0, kitsui_34.Component)().style('plug-tooltip-clarity-labelled-line-label').append(...ClarityChildren(data.label, data)))
                    .append((0, kitsui_34.Component)().style('plug-tooltip-clarity-labelled-line-value').append(...ClarityChildren(data.value, data)))),
                pve: (component, data) => (component
                    .style('plug-tooltip-clarity-pvevp', 'plug-tooltip-clarity-pve')
                    .prepend((0, kitsui_34.Component)().style('plug-tooltip-clarity-pvevp-label').text.set(quilt => quilt['plug-tooltip/clarity/label-pve']()))),
                pvp: (component, data) => (component
                    .style('plug-tooltip-clarity-pvevp', 'plug-tooltip-clarity-pvp')
                    .prepend((0, kitsui_34.Component)().style('plug-tooltip-clarity-pvevp-label').text.set(quilt => quilt['plug-tooltip/clarity/label-pvp']()))),
...
define("component/overlay/ItemOverlay", ["require", "exports", "component/core/Image", "component/core/Lore", "component/item/Item", "component/item/Power", "component/item/Stats", "component/tooltip/GenericTooltip", "component/tooltip/PlugTooltip", "kitsui", "kitsui/component/Slot", "kitsui/utility/InputBus", "model/ArmourSet", "model/DisplayProperties", "Relic", "utility/Categorisation"], function (require, exports, Image_5, Lore_2, Item_1, Power_2, Stats_3, GenericTooltip_1, PlugTooltip_1, kitsui_35, Slot_5, InputBus_2, ArmourSet_2, DisplayProperties_4, Relic_9, Categorisation_2) {
    ...
    const PowerStatDefinition = kitsui_35.State.Async(async () => {
    ...
    exports.default = (0, kitsui_35.Component)((component, intendedItem, collections) => {
        // preserve all the ui for the last item when the "intended" item is set to undefined
        const item = (0, kitsui_35.State)(undefined);
        kitsui_35.State.get(intendedItem).use(component, intendedItem => item.value = intendedItem ?? item.value);
        collections = kitsui_35.State.get(collections);
        const overlay = component.style('item-overlay');
        const background = (0, kitsui_35.Component)().style('item-overlay-background').appendTo(overlay);
        (0, Image_5.default)(item.map(overlay, item => item?.previewImage && `https://www.bungie.net${item.previewImage}`))
            .style('item-overlay-image')
            .appendTo(background);
        const foundryImage = kitsui_35.State.Map(overlay, [collections, item], (collections, item) => DisplayProperties_4.default.icon(collections.foundries[item?.foundryHash]?.overlay));
        (0, Image_5.default)(foundryImage)
            .style('item-overlay-foundry')
            .appendTo(background);
        const mainColumn = (0, kitsui_35.Component)()
            .style('item-overlay-column-content')
            .appendTo((0, kitsui_35.Component)()
        ...
        (0, kitsui_35.Component)()
            ...
            .append((0, kitsui_35.Component)().style('item-overlay-title').text.bind(item.map(overlay, item => item?.displayProperties.name)))
            .append((0, kitsui_35.Component)().style('item-overlay-subtitle').text.bind(item.map(overlay, item => item?.type)))
            .appendTo(mainColumn);
        ...
        const Plug = (0, kitsui_35.Component)('button', (component, plug) => {
        ...
        const Socket = (0, kitsui_35.Component)((component, socket, collections) => {
        ...
        ////////////////////////////////////
        //#region Weapon Perks
        const isWeapon = item.map(component, item => !!item?.categoryHashes?.includes(1 /* ItemCategoryHashes.Weapon */));
        SocketGroup(4241085061 /* SocketCategoryHashes.WeaponPerks_CategoryStyle1 */)
            ...
            if (!item?.instanceId)
                for (let i = 0; i < sockets.length; i++) {
                    if (i)
                        (0, kitsui_35.Component)().style('item-overlay-socket-group-gap').appendTo(slot);
                ...
                if (!item?.instanceId) {
                    for (let i = 0; i < sockets.length; i++) {
                        ...
                        Socket(sockets[i], collections)
                            ...
                            .append(!Categorisation_2.default.IsFrame(sockets[i]) || !plug ? undefined : (0, kitsui_35.Component)()
        ...
        (0, Slot_5.default)().appendTo(mainColumn).use(itemSet, (slot, itemSet) => {
            ...
            return SocketGroup(itemSet.definition)
                ...
                for (let i = 0; i < itemSet.perks.length; i++) {
                    if (i)
                        (0, kitsui_35.Component)().style('item-overlay-socket-group-gap').appendTo(group.content);
        ...
        //#endregion
        ////////////////////////////////////
        const sideColumn = (0, kitsui_35.Component)()
        ...
        ////////////////////////////////////
        //#region Stats
        const ammo = kitsui_35.State.Map(overlay, [item, collections], (item, collections) => collections.ammoTypes[item?.ammoType]);
        ...
        (0, kitsui_35.Component)()
            ...
            .append((0, Power_2.default)(kitsui_35.State.Use(stats, { damageTypes: item.map(stats, item => item?.damageTypeHashes) }), collections)
            .style('item-overlay-stats-primary-power-display')))
            .appendWhen(ammo.truthy, (0, kitsui_35.Component)()
...
define("component/core/Details", ["require", "exports", "kitsui"], function (require, exports, kitsui_36) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Details = (0, kitsui_36.Component)('details', (component) => {
        const open = (0, kitsui_36.State)(false);
        const manualOpenState = (0, kitsui_36.State)(false);
        const transitioning = (0, kitsui_36.State)(false);
        const summary = (0, kitsui_36.Component)('summary').style('details-summary');
        const content = (0, kitsui_36.Component)().style('details-content').style.bind(open, 'details-content--open');
...
define("component/view/collections/Moment", ["require", "exports", "component/core/Details", "component/core/Image", "component/core/Lore", "component/item/Item", "kitsui"], function (require, exports, Details_1, Image_6, Lore_3, Item_2, kitsui_37) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const MomentBucket = (0, kitsui_37.Component)((component) => {
    ...
    exports.default = (0, kitsui_37.Component)((component, { moment, buckets }, collections, display) => {
        display = kitsui_37.State.get(display);
        ...
        return component.and(Details_1.default)
            ...
            .append(moment.iconWatermark && (0, kitsui_37.Component)()
            ...
            const ItemFilterState = (item) => kitsui_37.State.Map(details, [display, filterText, details.manualOpenState, details.transitioning], (display, filterText, open, transitioning) => ({
                filterText,
            ...
            const hasAnyItemFilteredIn = kitsui_37.State.Map(details, [...itemFilterStates.values()], (...states) => states.some(state => state.filterState));
            kitsui_37.State.Use(details, {
                filterText,
                hasAnyItemFilteredIn,
                delayed: kitsui_37.State.Delayed(details, { filterText, hasAnyItemFilteredIn }, 100),
            ...
            void details.open.await(details, true).then(() => {
                ...
                const bucketsWrapper = (0, kitsui_37.Component)()
                ...
                const addFilteredItems = (bucket, items) => {
                    ...
                    for (const item of items) {
                        ...
                        if (!filterState)
                            continue;
                        const shouldShowItem = (0, kitsui_37.State)(false);
                        let wasOpen = false;
                        ...
                        void shouldShowItem.await(bucket, true).then(() => {
                            ...
                            const itemComponentToPositionAfter = bucket.content.getDescendants(Item_2.default).toArray().findLast(item => items.indexOf(item.item.value) < ownIndex);
                    ...
                    const shouldShowBucket = kitsui_37.State.Some(details, ...filterStates);
...
define("utility/Time", ["require", "exports", "kitsui"], function (require, exports, kitsui_38) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Time;
    (function (Time) {
        Time.state = (0, kitsui_38.State)(Date.now() / 1000);
...
define("component/view/CollectionsView", ["require", "exports", "component/core/View", "component/display/filter/FilterAmmo", "component/display/filter/FilterElement", "component/display/filter/FilterRarity", "component/display/filter/FilterWeaponFoundry", "component/display/filter/FilterWeaponFrame", "component/display/filter/FilterWeaponType", "component/DisplayBar", "component/Overlay", "component/overlay/ItemOverlay", "component/view/collections/Moment", "kitsui", "kitsui/component/Loading", "kitsui/component/Slot", "kitsui/utility/Task", "Relic", "utility/Async", "utility/Time"], function (require, exports, View_1, FilterAmmo_1, FilterElement_1, FilterRarity_1, FilterWeaponFoundry_1, FilterWeaponFrame_1, FilterWeaponType_2, DisplayBar_2, Overlay_2, ItemOverlay_1, Moment_1, kitsui_39, Loading_2, Slot_6, Task_4, Relic_10, Async_1, Time_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const COLLECTIONS_DISPLAY = DisplayBar_2.default.Config({
        ...
        filterConfig: {
            id: 'collections',
            filters: [FilterElement_1.default, FilterAmmo_1.default, FilterWeaponType_2.default, FilterWeaponFrame_1.default, FilterWeaponFoundry_1.default, FilterRarity_1.default],
            debounceTime: 500,
        },
    });
    const ActiveEvent = kitsui_39.State.Async(async () => {
    ...
    exports.default = (0, View_1.default)(async (view) => {
        ...
        const changingFilter = (0, kitsui_39.State)(false);
        view.title
        ...
        const collections = (0, kitsui_39.State)(await conduit.getCollections());
        if (signal.aborted)
            return;
        ...
        ////////////////////////////////////
        //#region Collections
        const filterText = (0, kitsui_39.State)(undefined);
        ...
        (0, Slot_6.default)().subviewTransition('collections-content').appendTo(view).use({ collections, ActiveEvent }, (slot, { collections, ActiveEvent }) => {
            ...
            //#region Active Event
            if (ActiveEvent) {
                const eventWrapper = (0, kitsui_39.Component)()
                ...
                const shouldShow = kitsui_39.State.Map(momentComponent, [momentComponent.open, filterText], (open, filterText) => open || !filterText);
            ...
            for (const moment of collections.moments) {
                ...
                if (moment.moment.year !== year) {
                    ...
                    yearWrapper = !year ? undefined : (0, kitsui_39.Component)()
            ...
            function handleYearWrapperEnd() {
                ...
                const shouldShow = kitsui_39.State.Map(yearWrapper, momentVisibilityStates, (...states) => states.includes(true));
        ...
        const overlayItem = kitsui_39.State.Map(view, [view.params, collections, itemMap], (params, collections, itemMap) => {
            if (!params)
                return undefined;
...
define("component/core/Paginator", ["require", "exports", "component/core/Button", "component/core/DisplaySlot", "kitsui", "kitsui/component/Loading"], function (require, exports, Button_5, DisplaySlot_4, kitsui_40, Loading_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Button_5 = __importDefault(Button_5);
    DisplaySlot_4 = __importDefault(DisplaySlot_4);
    Loading_3 = __importDefault(Loading_3);
    const Paginator = (0, kitsui_40.Component)((component) => {
        const state = (0, kitsui_40.State)(undefined);
        const currentPage = (0, kitsui_40.State)(-1);
        const totalPages = (0, kitsui_40.State)(0);
        const isLastPage = kitsui_40.State.MapManual([currentPage, totalPages], (page, total) => page >= total - 1);
        const lastDirection = (0, kitsui_40.State)(1);
        const pageData = [];
        const pages = [];
        const hasPageData = (0, kitsui_40.State)(false);
        const loading = (0, kitsui_40.State)(false);
        const shouldDisplay = kitsui_40.State.MapManual([hasPageData, totalPages], (hasPageData, totalPages) => hasPageData && totalPages >= 1);
        (0, Loading_3.default)()
            .style('paginator-loading')
            .showForever()
            .appendToWhen(loading, component);
        const Page = (0, kitsui_40.Component)((pageComponent, page) => {
            pageData[page] ??= (0, kitsui_40.State)(undefined);
        ...
        const pageContainer = (0, kitsui_40.Component)()
        ...
        currentPage.subscribeManual((page, lastPage) => {
            ...
            pageData[page] ??= kitsui_40.State.Async(component, async () => {
...
define("component/core/TabButton", ["require", "exports", "component/core/Button", "kitsui"], function (require, exports, Button_6, kitsui_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Button_6 = __importDefault(Button_6);
    const TabButton = (0, kitsui_41.Component)((component, active) => {
        const displayMode = (0, kitsui_41.State)('horizontal');
...
define("component/core/Tabinator", ["require", "exports", "component/core/Link", "component/core/TabButton", "kitsui"], function (require, exports, Link_2, TabButton_1, kitsui_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Link_2 = __importDefault(Link_2);
    TabButton_1 = __importDefault(TabButton_1);
    const Tabinator = (0, kitsui_42.Component)((component) => {
        // eslint-disable-next-line prefer-const
        let Tab;
        const displayMode = (0, kitsui_42.State)('horizontal');
        const hideWhenSingleTab = (0, kitsui_42.State)(false);
        const isSingleTab = kitsui_42.State.JIT(() => !!Tab && [...tabsWrapper.getChildren(Tab)].length <= 1);
        const header = (0, kitsui_42.Component)()
            .style('tabinator-header')
            .style.bind(displayMode.equals('vertical'), 'tabinator-header--vertical')
            .style.bind(kitsui_42.State.Every(component, hideWhenSingleTab, isSingleTab), 'tabinator-header--hidden')
            .appendTo(component);
        const tabsWrapper = (0, kitsui_42.Component)()
        ...
        const tabinatorDirection = (0, kitsui_42.State)(-1);
        const defaultSelection = (0, kitsui_42.State)(undefined);
        const currentURL = (0, kitsui_42.State)(undefined);
        Tab = (0, kitsui_42.Component)((component, route) => {
            if ([...tabsWrapper.getChildren(Tab)].every(tab => !tab.selected.value))
                defaultSelection.value ??= component;
            const selected = (0, kitsui_42.State)(false);
            const isDefaultSelection = defaultSelection.equals(component);
            selected.bind(component, isDefaultSelection);
            const tabId = Math.random().toString(36).slice(2);
            const tabContent = (0, kitsui_42.Component)()
            ...
            const enabled = (0, kitsui_42.State)(true);
            return component
                ...
                if (route) {
                    watchNavigation();
                    kitsui_42.State.Use(component, { currentURL, route: kitsui_42.State.get(route) }, ({ currentURL, route }) => {
                        if (currentURL === route)
                            selectTab(component);
                    });
                }
...
define("component/view/data/DataDefinitionButton", ["require", "exports", "component/core/Button", "component/core/Image", "component/view/data/DataHelper", "kitsui"], function (require, exports, Button_7, Image_7, DataHelper_1, kitsui_43) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Button_7 = __importDefault(Button_7);
    Image_7 = __importDefault(Image_7);
    DataHelper_1 = __importDefault(DataHelper_1);
    const DataDefinitionButton = (0, kitsui_43.Component)('a', (component) => component
        .and(Button_7.default)
        .style('data-view-definition-button')
        .extend(component => ({
        data: (0, kitsui_43.State)(undefined),
    }))
...
define("component/view/data/DataProvider", ["require", "exports", "kitsui", "Relic", "utility/Arrays", "utility/Objects"], function (require, exports, kitsui_44, Relic_11, Arrays_5, Objects_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function DataProvider(definition) {
        ...
        function getInternal(...params) {
            return {
                params,
                data: kitsui_44.State.Async(kitsui_44.State.Owner.create(), async (signal, setProgress) => {
        ...
        function createDefinitionsFilter(filterText) {
            ...
            for (const token of tokens) {
                if (token.startsWith('deep:')) {
                    Arrays_5.default.resolve(filter.deepContains ??= []).push(token.substring(5));
                    continue;
                }
                if (token.startsWith('$')) {
                    Arrays_5.default.resolve(filter.jsonPathExpression ??= []).push(token);
                    continue;
                }
                Arrays_5.default.resolve(filter.nameContainsOrHashIs ??= []).push(token);
            }
            return filter;
        }
...
define("component/overlay/DataOverlay", ["require", "exports", "component/core/Details", "component/core/DisplaySlot", "component/core/Image", "component/core/Link", "component/core/Paginator", "component/core/Tabinator", "component/view/data/DataDefinitionButton", "component/view/data/DataHelper", "component/view/data/DataProvider", "kitsui", "kitsui/component/Loading", "kitsui/component/Slot", "kitsui/utility/InputBus", "kitsui/utility/Task", "utility/Arrays"], function (require, exports, Details_2, DisplaySlot_5, Image_8, Link_3, Paginator_1, Tabinator_1, DataDefinitionButton_1, DataHelper_2, DataProvider_1, kitsui_45, Loading_4, Slot_7, InputBus_3, Task_5, Arrays_6) {
    ...
    exports.default = (0, kitsui_45.Component)((component, params) => {
        ...
        const JSONRender = (0, kitsui_45.Component)((component, value, links) => {
            links ??= (0, kitsui_45.State)(undefined);
            ////////////////////////////////////
            //#region JSON
            const JSONComponent = kitsui_45.Component.Tag();
            const JSONPunctuation = (0, kitsui_45.Component)((component, punctuationString) => component.and(JSONComponent)
                .style('data-overlay-json-punctuation')
                .text.set(punctuationString));
            const JSONPlaceholder = (0, kitsui_45.Component)((component, text) => component.and(JSONComponent)
                .style('data-overlay-json-placeholder')
                .text.set(text));
            ////////////////////////////////////
            //#region Copypaste
            const JSONCopyPaste = (0, kitsui_45.Component)((component, value) => component.and(JSONComponent)
            ...
            const JSONContainer = (0, kitsui_45.Component)((component, key, value, path, holdIn, isSoloKey = false) => {
                ...
                let container;
                const keyComponent = (0, kitsui_45.Component)('a')
                    .setOwner(component)
                    .style('data-overlay-json-container-entry-key')
                    .attributes.set('href', `#${pathString}`)
                    .append(...typeof key === 'object' ? Arrays_6.default.resolve(key) : [])
                ...
                const hold = (0, kitsui_45.State)(false);
                if (holdIn)
            ...
            const JSONObject = (0, kitsui_45.Component)((component, object, path, hold) => {
            ...
            const JSONArray = (0, kitsui_45.Component)((component, array, path, hold) => {
            ...
            const JSONCascade = (array, path, hold, init) => {
                ...
                const result = (0, kitsui_45.Component)();
                if (chunks.length === 1) {
                ...
                function cascadeChunk(chunk) {
                    ...
                    return (0, kitsui_45.Component)()
                        ...
                        const expandable = (0, kitsui_45.Component)()
                            .style('data-overlay-json-container-expandable')
                            .appendTo(details.content);
                        const openedOnce = (0, kitsui_45.State)(false);
                        kitsui_45.State.Every(details, details.open, openedOnce.falsy).use(details, open => {
                            if (!open)
                                return;
            ...
            ////////////////////////////////////
            //#region Literals
            const JSONString = (0, kitsui_45.Component)((component, string) => component.and(JSONComponent)
                ...
                .append(JSONPunctuation('"')));
            const JSONNumber = (0, kitsui_45.Component)((component, number, path) => component.and(JSONComponent)
                .style('data-overlay-json', 'data-overlay-json-number')
                .append(JSONCopyPaste(number))
                .append(JSONLinks(number, path)));
            const JSONBool = (0, kitsui_45.Component)((component, bool) => component.and(JSONComponent)
                .style('data-overlay-json', 'data-overlay-json-boolean')
                .text.set(bool ? 'true' : 'false'));
            const JSONNull = (0, kitsui_45.Component)(component => component.and(JSONComponent)
            ...
            const JSONImage = (0, kitsui_45.Component)((component, url) => component.and(JSONComponent)
                ...
                .tweak(wrapper => {
                const preview = (0, kitsui_45.Component)()
            ...
            ////////////////////////////////////
            //#region Links
            const JSONLinks = (0, kitsui_45.Component)((component, key, path, leadingSpace = ' ') => component.and(DisplaySlot_5.default).use(links, (slot, links) => {
                if (!links)
                    return;
                const pathString = path?.join('.') ?? '';
                ...
                if (!link)
                    return;
                const ref = (0, kitsui_45.Component)()
        ...
        ////////////////////////////////////
        //#region References
        const referencesCount = (0, kitsui_45.State)(undefined);
        ...
        (0, Slot_7.default)().appendTo(referencesTab.content).use(dedupedParams, (slot, params) => {
            ...
            (0, Paginator_1.default)()
                ...
                init(paginator, slot, page, data) {
                    ...
                    const list = (0, kitsui_45.Component)()
                        .style('data-view-definition-list')
                        .appendTo(slot);
...
define("component/view/DataView", ["require", "exports", "component/core/Button", "component/core/Details", "component/core/DisplaySlot", "component/core/Link", "component/core/Paginator", "component/core/TabButton", "component/core/View", "component/display/Filter", "component/DisplayBar", "component/Overlay", "component/overlay/DataOverlay", "component/view/data/DataDefinitionButton", "component/view/data/DataHelper", "component/view/data/DataProvider", "kitsui", "kitsui/component/Loading", "kitsui/component/Slot", "kitsui/utility/Arrays", "kitsui/utility/Functions", "lang", "Relic", "utility/Async", "utility/Objects", "utility/Time"], function (require, exports, Button_8, Details_3, DisplaySlot_6, Link_4, Paginator_2, TabButton_2, View_2, Filter_8, DisplayBar_3, Overlay_3, DataOverlay_1, DataDefinitionButton_2, DataHelper_3, DataProvider_2, kitsui_46, Loading_5, Slot_8, Arrays_7, Functions_1, lang_2, Relic_12, Async_2, Objects_4, Time_2) {
        ...
        filterConfig: {
            ...
            plaintextFilterTweakChip(chip, token) {
                if (token.lowercase.startsWith('deep:'))
                    token = Filter_8.FilterToken.create(token.slice(5));
                (0, Filter_8.PLAINTEXT_FILTER_TWEAK_CHIP)(chip, token);
            },
    ...
    const currentTime = (0, kitsui_46.State)(Date.now());
    ...
    exports.default = (0, View_2.default)(async (view) => {
        ...
        const lastCheck = (0, kitsui_46.State)(undefined);
        const state = kitsui_46.State.Async(view, async () => {
        ...
        if (signal.aborted)
            return;
        const componentNames = kitsui_46.State.Async(view, () => conduit.getComponentNames());
        const links = kitsui_46.State.Async(view, () => conduit.definitions.en.DeepsightLinksDefinition.all());
        ...
        (0, Loading_5.default)()
            ...
            (0, kitsui_46.Component)()
                ...
                .append((0, kitsui_46.Component)().style('data-view-versions-text-provider').text.set(quilt => quilt['view/data/versions/label']()), (0, kitsui_46.Component)().style('data-view-versions-text-punctuation').text.set(': '))
                .append(...Object.entries(simplified)
                .filter(([, version]) => version)
                .flatMap(([provider, version], i) => [
                i && (0, kitsui_46.Component)().style('data-view-versions-text-punctuation').text.set(' / '),
                (0, kitsui_46.Component)().style('data-view-versions-text-version').text.set(version),
            ])
                .filter(Arrays_7.Truthy))
            ...
            (0, kitsui_46.Component)()
                ...
                .flatMap(([provider, version], i) => [
                i && (0, kitsui_46.Component)().style('data-view-versions-text-punctuation').text.set(' / '),
                (0, kitsui_46.Component)().style('data-view-versions-text-provider').text.set(provider),
                (0, kitsui_46.Component)().style('data-view-versions-text-punctuation').text.set(': '),
                (0, kitsui_46.Component)().style('data-view-versions-text-version').text.set(version),
            ])
                .filter(Arrays_7.Truthy))
            ...
            (0, kitsui_46.Component)()
                ...
                .tweak(button => button
                .text.bind(kitsui_46.State.Map(slot, [currentTime, lastCheck, button.hoveredOrHasFocused], (elapsed, last, hovered) => quilt => quilt['view/data/versions/action/check'](!last || !hovered ? undefined : Time_2.default.relative(last, { components: 1 })))))
        ...
        (0, Slot_8.default)()
            ...
            for (let i = 0; i < componentNames.length; i++) {
                ...
                if (category && !groupWrappers.has(category)) {
                    const filteredIn = (0, kitsui_46.State)(false);
                ...
                details.summary
                    ...
                    .append(augments && (0, kitsui_46.Component)()
                ...
                const openedOnce = (0, kitsui_46.State)(!!filterText);
                kitsui_46.State.Some(details, openedOnce, details.open).useManual(opened => {
                    if (!opened)
                        return;
                    openedOnce.value = true;
                    const pageSize = 50;
                    ...
                    (0, Paginator_2.default)()
                        ...
                        init(paginator, slot, page, data) {
                            const list = (0, kitsui_46.Component)()
                                .style('data-view-definition-list')
                                .appendTo(slot);
                            if (!data) {
            ...
            for (const wrapper of groupWrappers.values()) {
                const filteredIn = kitsui_46.State.Map(wrapper.details, wrapper.filteredInStates, (...states) => states.some(v => v));
            ...
            .appendTo(view);
        const breadcrumbs = (0, kitsui_46.State)([]);
        const homeLinkURL = navigate.state.map(view, url => {
            const route = new URL(url).pathname;
        ...
        view.getNavbar()
            ...
            const wrapper = (0, kitsui_46.Component)()
        ...
        ////////////////////////////////////
        //#region Data Overlay
        const overlayDefinition = kitsui_46.State.Async(view, view.params, async (params, signal, setProgress) => {
            if (!params)
                return undefined;
            ...
            const result = params.hash !== 'full'
                ...
                : kitsui_46.State.Async(kitsui_46.State.Owner.fromSignal(signal), async () => {
                    const conduit = await Relic_12.default.connected;
                    if (signal.aborted)
                        return undefined;
        ...
        const hasPendingOverlayDefinition = kitsui_46.State.Every(view, view.params.truthy, overlayDefinition.settled.falsy);
        const shouldShowOverlay = kitsui_46.State.Some(view, overlayDefinition.truthy, hasPendingOverlayDefinition);
...
define("component/core/Card", ["require", "exports", "component/core/Lore", "component/core/Paragraph", "kitsui"], function (require, exports, Lore_4, Paragraph_3, kitsui_47) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Lore_4 = __importDefault(Lore_4);
    Paragraph_3 = __importDefault(Paragraph_3);
    const Card = (0, kitsui_47.Component)((component) => {
        let header;
        const flush = (0, kitsui_47.State)(false);
        return component.style('card')
            .style.bind(flush, 'card--flush')
            .style.bind(kitsui_47.State.Every(component, flush, component.hoveredOrHasFocused), 'card--flush--hover')
            .extend(card => ({
            header: undefined,
            ...
            .extendJIT('header', card => header ??= (0, kitsui_47.Component)()
            .style('card-header')
            .style.bind(flush, 'card-header--flush')
            .tweak(header => {
            const text = (0, kitsui_47.Component)().style('card-header-text').appendTo(header);
...
define("component/view/SplashView", ["require", "exports", "component/core/Button", "component/core/Card", "component/core/DisplaySlot", "component/core/Link", "component/core/View", "component/profile/ProfileButton", "component/WordmarkLogo", "kitsui", "model/Profile", "Relic"], function (require, exports, Button_9, Card_1, DisplaySlot_7, Link_5, View_3, ProfileButton_2, WordmarkLogo_2, kitsui_48, Profile_2, Relic_13) {
    ...
    exports.default = (0, View_3.default)(async (view) => {
        ...
        (0, Link_5.default)('/')
            ...
            .appendTo((0, kitsui_48.Component)()
        ...
        const columns = (0, kitsui_48.Component)().style('splash-view-columns').appendTo(view.loading);
        const Column = () => (0, kitsui_48.Component)()
...
define("navigation/Navigate", ["require", "exports", "kitsui", "kitsui/component/Dialog", "kitsui/component/Popover", "kitsui/utility/EventManipulator", "navigation/Routes"], function (require, exports, kitsui_49, Dialog_1, Popover_2, EventManipulator_1, Routes_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Navigator() {
        const state = (0, kitsui_49.State)(location.href);
        const hash = (0, kitsui_49.State)(location.hash);
        const search = (() => {
            const state = (0, kitsui_49.State)({});
...
define("index", ["require", "exports", "component/Kit", "kitsui", "kitsui/utility/ActiveListener", "kitsui/utility/FocusListener", "kitsui/utility/HoverListener", "kitsui/utility/Mouse", "kitsui/utility/Viewport", "model/Profile", "navigation/Navigate", "Relic", "utility/Arrays", "utility/DevServer", "utility/Env", "utility/Strings", "utility/Text"], function (require, exports, Kit_1, kitsui_50, ActiveListener_1, FocusListener_1, HoverListener_1, Mouse_2, Viewport_1, Profile_3, Navigate_1, Relic_14, Arrays_8, DevServer_1, Env_4, Strings_1, Text_2) {
    ...
    async function default_1() {
        kitsui_50.Component.allowBuilding();
        Text_2.default.init();
        kitsui_50.Component.getBody().style('body');
        await Env_4.default['init']();
        void Relic_14.default.init();
        ...
        kitsui_50.Component.getBody().monitorScrollEvents();
        kitsui_50.Component.getDocument().monitorScrollEvents();
        kitsui_50.Component.getWindow().monitorScrollEvents();
        (0, Kit_1.default)();
        await (0, Navigate_1.default)().fromURL();
    }
});
define("component/core/ActionRow", ["require", "exports", "kitsui"], function (require, exports, kitsui_51) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_51.Component)(component => component.style('action-row'));
});
define("component/core/Checkbox", ["require", "exports", "kitsui"], function (require, exports, kitsui_52) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Checkbox = (0, kitsui_52.Component)('label', (component) => {
        const label = (0, kitsui_52.Component)().style('checkbox-label');
        const checked = (0, kitsui_52.State)(false);
        const input = (0, kitsui_52.Component)('input')
...
define("component/core/Checklist", ["require", "exports", "kitsui"], function (require, exports, kitsui_53) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Checklist = (0, kitsui_53.Component)('ol', (component) => {
    ...
    const ChecklistItem = (0, kitsui_53.Component)('li', (component) => {
        const checked = (0, kitsui_53.State)(false);
        const marker = (0, kitsui_53.Component)().style('checklist-item-marker');
        const content = (0, kitsui_53.Component)().style('checklist-item-content');
        const checkIcon = (0, kitsui_53.Component)()
...
define("component/core/Footer", ["require", "exports", "kitsui"], function (require, exports, kitsui_54) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_54.Component)(component => component.style('footer'));
});
define("component/core/FormRow", ["require", "exports", "kitsui"], function (require, exports, kitsui_55) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const FormRow = (0, kitsui_55.Component)('label', (component) => {
        const label = (0, kitsui_55.Component)().style('form-row-label');
...
define("component/core/TextInput", ["require", "exports", "kitsui", "kitsui/utility/Applicator"], function (require, exports, kitsui_56, Applicator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Applicator_1 = __importDefault(Applicator_1);
    const TextInput = (0, kitsui_56.Component)('input', (component) => {
        let defaultValue = '';
        const state = (0, kitsui_56.State)(defaultValue);
