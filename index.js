...
define("component/core/Image", ["require", "exports", "kitsui", "kitsui/utility/Task"], function (require, exports, kitsui_10, Task_2) {
    ...
    exports.default = (0, kitsui_10.Component)('img', (component, src) => {
...
define("component/display/filter/FilterElement", ["require", "exports", "component/core/Image", "component/display/Filter", "kitsui", "Relic"], function (require, exports, Image_1, Filter_1, kitsui_11, Relic_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Image_1 = __importDefault(Image_1);
    Filter_1 = __importDefault(Filter_1);
    Relic_2 = __importDefault(Relic_2);
    const DestinyDamageTypeDefinition = kitsui_11.State.Async(kitsui_11.State.Owner.create(), async (signal, setProgress) => {
    ...
    exports.default = Filter_1.default.Definition({
        ...
        match(owner, token) {
            ...
            return {
                ...
                icon(icon, token) {
                    (0, Image_1.default)(damageType.map(icon, def => def && `https://www.bungie.net${def.displayProperties.icon}`))
...
define("component/DisplayBar", ["require", "exports", "component/core/Button", "component/display/Filter", "component/display/filter/FilterElement", "kitsui"], function (require, exports, Button_2, Filter_2, FilterElement_1, kitsui_12) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Button_2 = __importDefault(Button_2);
    Filter_2 = __importDefault(Filter_2);
    FilterElement_1 = __importDefault(FilterElement_1);
    const DisplayBarButton = (0, kitsui_12.Component)((component) => {
        ...
        (0, kitsui_12.Component)()
            .style('display-bar-button-icon')
            .appendTo(button);
        const title = (0, kitsui_12.Component)()
            .style('display-bar-button-title')
            .appendTo(button);
        const subtitle = (0, kitsui_12.Component)()
    ...
    const DisplayBar = Object.assign((0, kitsui_12.Component)((component) => {
        ...
        DisplayBarButton()
            ...
            .appendTo(component);
        const config = (0, kitsui_12.State)(undefined);
        return component
            .extend(displayBar => ({
            config,
            handlers: {
            ...
            .appendToWhen(config.truthy, kitsui_12.Component.getBody());
    }), {
        Config(config) {
            return config;
        },
...
define("component/core/Link", ["require", "exports", "kitsui"], function (require, exports, kitsui_13) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Link = (0, kitsui_13.Component)('a', (component, hrefIn) => {
        const href = (0, kitsui_13.State)(hrefIn);
        return component
            .replaceElement('a')
...
define("component/core/Icon", ["require", "exports", "kitsui", "style/icons"], function (require, exports, kitsui_14, icons_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Icon = (0, kitsui_14.Component)((component, icon) => {
        return component
...
define("component/profile/ProfileButton", ["require", "exports", "component/core/Button", "component/core/Icon", "kitsui"], function (require, exports, Button_3, Icon_1, kitsui_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Button_3 = __importDefault(Button_3);
    Icon_1 = __importDefault(Icon_1);
    const ProfileButton = (0, kitsui_15.Component)((component, profile) => {
        const displayMode = (0, kitsui_15.State)('collapsed');
        ...
        (0, kitsui_15.Component)()
            .style('profile-button-icon')
            .style.bind(isSimple, 'profile-button-icon--overlay')
            .style.bind(kitsui_15.State.Every(button, isSimple, button.hoveredOrHasFocused), 'profile-button-icon--overlay--hover')
        ...
        (0, kitsui_15.Component)()
            ...
            .append((0, kitsui_15.Component)().style('profile-button-name-display').text.set(profile.name))
            .append((0, kitsui_15.Component)().style('profile-button-name-code').text.set(`#${profile.code}`))
            .appendTo(button);
        (0, kitsui_15.Component)()
        ...
        if (profile.guardianRank)
            (0, kitsui_15.Component)()
                ...
                .append((0, kitsui_15.Component)().style('profile-button-guardian-rank-icon-number').text.set(profile.guardianRank.rank.toString())))
                .append((0, kitsui_15.Component)().style('profile-button-guardian-rank-name').text.set(profile.guardianRank.name))
                .appendToWhen(displayMode.equals('expanded'), button);
...
define("component/WordmarkLogo", ["require", "exports", "kitsui", "utility/Env"], function (require, exports, kitsui_16, Env_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Env_2 = __importDefault(Env_2);
    exports.default = (0, kitsui_16.Component)(component => {
        return component.style('wordmark-logo')
            .append((0, kitsui_16.Component)('img')
...
define("component/Navbar", ["require", "exports", "component/core/Link", "component/profile/ProfileButton", "component/WordmarkLogo", "kitsui", "kitsui/component/Slot", "model/Profile"], function (require, exports, Link_1, ProfileButton_1, WordmarkLogo_1, kitsui_17, Slot_3, Profile_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Navbar = (0, kitsui_17.Component)('nav', (component) => {
        const visible = (0, kitsui_17.State)(false);
        const viewTransitionsEnabled = (0, kitsui_17.State)(false);
        ...
        return component.style('navbar')
            ...
            .appendToWhen(visible, kitsui_17.Component.getBody());
    });
    exports.default = Navbar;
});
define("component/Overlay", ["require", "exports", "kitsui"], function (require, exports, kitsui_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const visibleOverlays = new Set();
    const hasVisible = (0, kitsui_18.State)(false);
    const Overlay = Object.assign((0, kitsui_18.Component)((component, owner) => {
        let unsubscribe;
        return component
            .setOwner(owner)
            .appendTo(document.body)
...
define("component/core/View", ["require", "exports", "component/DisplayBar", "component/Navbar", "component/Overlay", "kitsui", "kitsui/component/Loading", "kitsui/utility/Task", "utility/ViewTransition"], function (require, exports, DisplayBar_1, Navbar_1, Overlay_1, kitsui_19, Loading_1, Task_3, ViewTransition_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const ViewExt = kitsui_19.Component.Extension(view => view);
    let viewContainer;
    let navbar;
    let displayBar;
    function View(builder) {
        const hasNavbar = (0, kitsui_19.State)(true);
        const displayBarConfig = (0, kitsui_19.State)(undefined);
        return (0, kitsui_19.Component)((component, paramsIn) => {
            const params = (0, kitsui_19.State)(paramsIn);
            ...
            const trans = ViewTransition_2.default.perform('view', () => {
                ...
                viewContainer ??= (0, kitsui_19.Component)()
                    ...
                    Overlay_1.default.hasVisible.use(container, async (hasVisible) => {
                        if (hasVisible) {
                            ...
                            kitsui_19.Component.getDocument().style.removeVariables('overlay-scroll-margin-top');
                            return;
                        }
                        const overlayScrollTop = document.documentElement.scrollTop;
                        kitsui_19.Component.getDocument().style.setVariable('overlay-scroll-margin-top', `${-overlayScrollTop}px`);
                        document.documentElement.scrollTop = 0;
                        container.style.remove('view-container--has-overlay');
                        await Task_3.default.yield();
                        kitsui_19.Component.getDocument().style.setVariable('overlay-scroll-margin-top', `${savedScroll - overlayScrollTop}px`);
...
define("component/core/Paragraph", ["require", "exports", "kitsui"], function (require, exports, kitsui_20) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("component/core/Lore", ["require", "exports", "component/core/Paragraph", "kitsui"], function (require, exports, Paragraph_1, kitsui_21) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Paragraph_1 = __importDefault(Paragraph_1);
    exports.default = (0, kitsui_21.Component)(component => component.and(Paragraph_1.default).style('lore'));
});
define("component/item/Power", ["require", "exports", "kitsui", "Relic"], function (require, exports, kitsui_22, Relic_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Relic_3 = __importDefault(Relic_3);
    const prismaticIcon = kitsui_22.State.Async(kitsui_22.State.Owner.create(), async (signal, setProgress) => {
    ...
    exports.default = (0, kitsui_22.Component)((component, power, collections) => {
        collections = kitsui_22.State.get(collections);
        component.style('power');
        // eslint-disable-next-line @typescript-eslint/no-non-null-asserted-optional-chain
        const primaryDamageType = kitsui_22.State.Map(component, [power, collections], (power, collections) => collections.damageTypes[power?.damageTypes?.[0]]);
        ...
        (0, kitsui_22.Component)()
            ...
            kitsui_22.State.Use(wrapper, { primaryDamageType, damageTypes, prismaticIcon }).use(wrapper, ({ damageTypes, prismaticIcon }) => {
                ...
                if (damageTypes?.length === 5) {
                    ...
                    (0, kitsui_22.Component)()
                        ...
                        .appendTo(wrapper);
                    const gradientFixer = (0, kitsui_22.Component)()
...
define("component/item/Stats", ["require", "exports", "kitsui"], function (require, exports, kitsui_23) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const Stats = (0, kitsui_23.Component)((component, item, collections, display) => {
        item = kitsui_23.State.get(item);
        collections = kitsui_23.State.get(collections);
        component.style('stats');
        const statsVisible = (0, kitsui_23.State)(false);
        const hasStats = (0, kitsui_23.State)(false);
        const isAbbreviated = (0, kitsui_23.State)(false);
        kitsui_23.State.Use(component, { item, collections, isAbbreviated }, ({ item, collections, isAbbreviated }) => {
            component.removeContents();
            let _barStatsWrapper;
            let _numericStatsWrapper;
            const barStatsWrapper = () => _barStatsWrapper ??= (0, kitsui_23.Component)().style('stats-section').tweak(display?.tweakStatSection).prependTo(component);
            const numericStatsWrapper = () => _numericStatsWrapper ??= (0, kitsui_23.Component)().style('stats-section').tweak(display?.tweakStatSection).appendTo(component);
            // eslint-disable-next-line @typescript-eslint/no-non-null-asserted-optional-chain
            ...
            for (const stat of stats) {
                ...
                (0, kitsui_23.Component)()
                    .style('stats-stat')
                    .append((0, kitsui_23.Component)()
                    .style('stats-stat-label')
                    .text.set(statName)
                    .tweak(display?.tweakStatLabel, def, stat))
                    .append(!stat.displayAsNumeric && (0, kitsui_23.Component)()
...
define("utility/Categorisation", ["require", "exports"], function (require, exports) {
    ...
    (function (Categorisation) {
        ...
        Categorisation.IsIntrinsic = matcher('Intrinsic/*', '!Intrinsic/Shaped');
...
define("utility/TooltipManager", ["require", "exports", "kitsui"], function (require, exports, kitsui_24) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function TooltipManager(componentBuilder, definition) {
        ...
        const result = {
            apply(component, ...params) {
                ...
                kitsui_24.State.Use(component, { focused: componentWithPopover.hoveredOrHasFocused, visible: componentWithPopover.popover.visible }).subscribe(component, ({ focused, visible }, { visible: oldVisible } = { focused: false, visible: false }) => {
...
define("component/tooltip/ItemTooltip", ["require", "exports", "component/core/DisplaySlot", "component/core/Image", "component/core/Lore", "component/core/Paragraph", "component/item/Power", "component/item/Stats", "kitsui", "kitsui/component/Slot", "kitsui/component/Tooltip", "utility/Categorisation", "utility/Objects", "utility/TooltipManager"], function (require, exports, DisplaySlot_2, Image_2, Lore_1, Paragraph_2, Power_1, Stats_1, kitsui_25, Slot_4, Tooltip_1, Categorisation_1, Objects_1, TooltipManager_1) {
    ...
    const ItemTooltip = (0, kitsui_25.Component)((component, item, collections) => {
        ...
        ////////////////////////////////////
        //#region Primary Info
        const primaryInfo = (0, kitsui_25.Component)()
            .style('item-tooltip-primary-info')
            .appendTo(tooltip.body);
        ////////////////////////////////////
        //#region Damage
        (0, Power_1.default)(kitsui_25.State.Use(primaryInfo, { damageTypes: item.map(primaryInfo, item => item.damageTypes) }), collections)
        ...
        const ammo = kitsui_25.State.Map(tooltip, [item, collections], (item, collections) => collections.ammoTypes[item.ammo]);
        const archetype = kitsui_25.State.Map(tooltip, [item, collections], (item, collections) => {
        ...
        const secondaryType = kitsui_25.State.Map(tooltip, [archetype, ammo], (archetype, ammo) => {
        ...
        const itemSet = kitsui_25.State.Map(tooltip, [item, collections], (item, collections) => {
        ...
        (0, kitsui_25.Component)()
            ...
            .tweak(wrapper => {
            (0, Slot_4.default)().appendTo(wrapper).use(kitsui_25.State.Use(wrapper, { sockets: perks, itemSet, isCollections, collections }), (slot, { sockets, itemSet, isCollections, collections }) => {
                ////////////////////////////////////
                //#region Socket component
                const Plugs = (socket) => socket.plugs
                    .map(plugHash => collections.plugs[plugHash])
                    .filter(plug => !!plug);
                const Socket = (0, kitsui_25.Component)((wrapper, socket, plugs, noSocketed) => {
        ...
        sourceList.use({ item, collections }, (slot, { item, collections }) => {
            ...
            if (!sources?.length)
                return;
            const getSourceName = (source) => collections.sources[source.id]?.displayProperties.name;
            const getSourceCategory = (source) => collections.sources[source.id]?.category;
            const hasUniversalReward = sources
                .filter((source) => source.type === 'defined')
                .groupBy(getSourceName)
                .toObject(([name, sources]) => {
                const hasActivityRewardSource = sources.some(source => getSourceCategory(source) === 1 /* DeepsightItemSourceCategory.ActivityReward */);
                const hasBonusRewardSource = sources.some(source => getSourceCategory(source) === 5 /* DeepsightItemSourceCategory.BonusReward */);
                return [name ?? '', hasActivityRewardSource && hasBonusRewardSource];
            });
            const SourceWrapper = (0, kitsui_25.Component)((component, display) => {
                const icon = !display.icon ? undefined
                    : (0, Image_2.default)(`https://www.bungie.net${display.icon}`).style('item-tooltip-source-icon');
                const title = (0, kitsui_25.Component)()
                    .style('item-tooltip-source-title')
                    .text.set(display.name);
                const subtitle = !display.subtitle ? undefined : (0, kitsui_25.Component)()
            ...
            function resolveDisplay(sourceRef) {
                switch (sourceRef.type) {
                    case 'defined': {
                        ...
                        if (source.category === 5 /* DeepsightItemSourceCategory.BonusReward */ && isUniversalReward)
                            return undefined;
                        let subtitle = Objects_1._
                            // ?? (isUniversalReward ? quilt => quilt['item-tooltip/source/type/universal-reward']() : undefined)
                            ?? (isUniversalReward || source.category === 1 /* DeepsightItemSourceCategory.ActivityReward */ ? quilt => quilt['item-tooltip/source/type/activity-reward']() : undefined)
                            ?? (source.category === 5 /* DeepsightItemSourceCategory.BonusReward */ ? quilt => quilt['item-tooltip/source/type/bonus-reward']() : undefined)
        ...
        //#endregion
        ////////////////////////////////////
        kitsui_25.State.Use(tooltip, { item, collections }, () => tooltip.rect.markDirty());
        return tooltip;
    });
    exports.default = (0, TooltipManager_1.default)(ItemTooltip, {
        ...
        build(states, tooltip, item, collections) {
            item = kitsui_25.State.get(item);
            collections = kitsui_25.State.get(collections);
            return tooltip.and(ItemTooltip, states.item ??= kitsui_25.State.Mutable(tooltip, item), states.collections ??= kitsui_25.State.Mutable(tooltip, collections));
        },
        onHover(states, item, collections) {
            item = kitsui_25.State.value(item);
            console.log(item.displayProperties.name, item);
        },
    });
});
define("component/item/Item", ["require", "exports", "component/core/Button", "component/core/Image", "component/tooltip/ItemTooltip", "kitsui"], function (require, exports, Button_4, Image_3, ItemTooltip_1, kitsui_26) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Button_4 = __importDefault(Button_4);
    Image_3 = __importDefault(Image_3);
    ItemTooltip_1 = __importDefault(ItemTooltip_1);
    const Item = Object.assign((0, kitsui_26.Component)((component, item, collections) => {
        item = kitsui_26.State.get(item);
        collections = kitsui_26.State.get(collections);
...
define("component/tooltip/GenericTooltip", ["require", "exports", "kitsui", "kitsui/component/Tooltip", "utility/TooltipManager"], function (require, exports, kitsui_27, Tooltip_2, TooltipManager_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Tooltip_2 = __importDefault(Tooltip_2);
    TooltipManager_2 = __importDefault(TooltipManager_2);
    const GenericTooltipBuilder = (0, kitsui_27.Component)((component) => {
        ...
        const description = (0, kitsui_27.Component)()
    ...
    const GenericTooltip = (0, TooltipManager_2.default)(GenericTooltipBuilder, {
        ...
        build(states, tooltip, applicator) {
            return tooltip.and(GenericTooltipBuilder).tweak(tooltip => {
                states.applicator ??= (0, kitsui_27.State)(applicator);
...
define("component/tooltip/PlugTooltip", ["require", "exports", "component/core/DisplaySlot", "component/core/Icon", "component/core/Image", "component/item/Stats", "kitsui", "kitsui/component/Tooltip", "style/icons", "utility/TooltipManager"], function (require, exports, DisplaySlot_3, Icon_2, Image_4, Stats_2, kitsui_28, Tooltip_3, icons_2, TooltipManager_3) {
    ...
    const PlugTooltip = (0, kitsui_28.Component)((component, plug, collections) => {
        ...
        (0, DisplaySlot_3.default)().style('plug-tooltip-clarity').appendToWhen(clarity.truthy, tooltip.body).use(clarity, (slot, clarity) => {
            ...
            (0, kitsui_28.Component)()
                ...
                .append((0, kitsui_28.Component)().style('plug-tooltip-clarity-header-name').text.set('Clarity'))
            ...
            const clarityComponents = {
                ...
                labelledLine: (component, data, { siblings }, previousData = previousSibling(siblings, data)) => (component
                    ...
                    .append((0, kitsui_28.Component)().style('plug-tooltip-clarity-labelled-line-label').append(...ClarityChildren(data.label, data)))
                    .append((0, kitsui_28.Component)().style('plug-tooltip-clarity-labelled-line-value').append(...ClarityChildren(data.value, data)))),
                pve: (component, data) => (component
                    .style('plug-tooltip-clarity-pvevp', 'plug-tooltip-clarity-pve')
                    .prepend((0, kitsui_28.Component)().style('plug-tooltip-clarity-pvevp-label').text.set(quilt => quilt['plug-tooltip/clarity/label-pve']()))),
                pvp: (component, data) => (component
                    .style('plug-tooltip-clarity-pvevp', 'plug-tooltip-clarity-pvp')
                    .prepend((0, kitsui_28.Component)().style('plug-tooltip-clarity-pvevp-label').text.set(quilt => quilt['plug-tooltip/clarity/label-pvp']()))),
    ...
    exports.default = (0, TooltipManager_3.default)(PlugTooltip, {
        ...
        build(states, tooltip, plug, collections) {
            plug = kitsui_28.State.get(plug);
            collections = kitsui_28.State.get(collections);
            return tooltip.and(PlugTooltip, states.plug ??= kitsui_28.State.Mutable(tooltip, plug), states.collections ??= kitsui_28.State.Mutable(tooltip, collections));
        },
        onHover(states, plug, collections) {
            plug = kitsui_28.State.value(plug);
            console.log(plug.displayProperties.name, plug);
        },
    });
});
define("component/overlay/ItemOverlay", ["require", "exports", "component/core/Image", "component/core/Lore", "component/item/Item", "component/item/Power", "component/item/Stats", "component/tooltip/GenericTooltip", "component/tooltip/PlugTooltip", "kitsui", "kitsui/component/Slot", "kitsui/utility/InputBus", "Relic", "utility/Categorisation"], function (require, exports, Image_5, Lore_2, Item_1, Power_2, Stats_3, GenericTooltip_1, PlugTooltip_1, kitsui_29, Slot_5, InputBus_2, Relic_4, Categorisation_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, kitsui_29.Component)((component, intendedItem, collections) => {
        ...
        (0, kitsui_29.Component)()
            ...
            .append((0, kitsui_29.Component)().style('item-overlay-title').text.bind(item.map(overlay, item => item?.displayProperties.name)))
            .append((0, kitsui_29.Component)().style('item-overlay-subtitle').text.bind(item.map(overlay, item => item?.type)))
            .appendTo(mainColumn);
        ...
        const SocketGroup = (0, kitsui_29.Component)((component, socket) => {
            component.style.bind(component.hoveredOrHasFocused, 'item-overlay-socket-group--hover');
            const header = (0, kitsui_29.Component)()
            ...
            const title = (0, kitsui_29.Component)()
                ...
                .appendTo(header);
            const content = (0, kitsui_29.Component)()
        ...
        const Plug = (0, kitsui_29.Component)('button', (component, plug) => {
        ...
        const Socket = (0, kitsui_29.Component)((component, socket, collections) => {
        ...
        SocketGroup(4241085061 /* SocketCategoryHashes.WeaponPerks_CategoryStyle1 */)
            ...
            if (!item?.instanceId)
                for (let i = 0; i < sockets.length; i++) {
                    if (i)
                        (0, kitsui_29.Component)().style('item-overlay-socket-group-gap').appendTo(slot);
            ...
            if (!item?.instanceId)
                for (let i = 0; i < sockets.length; i++) {
                    ...
                    Socket(sockets[i], collections)
                        ...
                        .append(!Categorisation_2.default.IsFrame(sockets[i]) || !plug ? undefined : (0, kitsui_29.Component)()
                        .style('item-overlay-socket-display')
                        .append((0, kitsui_29.Component)()
        ...
        //#endregion
        ////////////////////////////////////
        const sideColumn = (0, kitsui_29.Component)()
        ...
        //#region Stats
        // eslint-disable-next-line @typescript-eslint/no-non-null-asserted-optional-chain
        const ammo = kitsui_29.State.Map(overlay, [item, collections], (item, collections) => collections.ammoTypes[item?.ammo]);
        ...
        (0, kitsui_29.Component)()
            ...
            .append((0, Power_2.default)(kitsui_29.State.Use(stats, { damageTypes: item.map(stats, item => item?.damageTypes) }), collections)
            .style('item-overlay-stats-primary-power-display')))
            .appendWhen(ammo.truthy, (0, kitsui_29.Component)()
...
define("component/core/Details", ["require", "exports", "kitsui"], function (require, exports, kitsui_30) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_30.Component)('details', (component) => {
        const open = (0, kitsui_30.State)(false);
        const manualOpenState = (0, kitsui_30.State)(false);
        const transitioning = (0, kitsui_30.State)(false);
        const summary = (0, kitsui_30.Component)('summary').style('details-summary');
        const content = (0, kitsui_30.Component)().style('details-content').style.bind(open, 'details-content--open');
...
define("component/view/collections/Moment", ["require", "exports", "component/core/Details", "component/core/Image", "component/core/Lore", "component/item/Item", "kitsui"], function (require, exports, Details_1, Image_6, Lore_3, Item_2, kitsui_31) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    const MomentBucket = (0, kitsui_31.Component)((component) => {
    ...
    exports.default = (0, kitsui_31.Component)((component, { moment, buckets }, collections, display) => {
        display = kitsui_31.State.get(display);
        ...
        return component.and(Details_1.default)
            ...
            .append(moment.iconWatermark && (0, kitsui_31.Component)()
            ...
            const ItemFilterState = (item) => kitsui_31.State.Map(details, [display, filterText], (display, _) => display?.filter.filter(item, false) ?? true);
            const itemFilterStates = new Map([...weapons, ...armour].map(item => [item, ItemFilterState(item)]));
            const hasAnyItemFilteredIn = kitsui_31.State.Some(details, ...itemFilterStates.values());
            kitsui_31.State.Use(details, { filterText, hasAnyItemFilteredIn }, ({ filterText, hasAnyItemFilteredIn }) => {
                if (!filterText) {
            ...
            void details.open.await(details, true).then(() => {
                ...
                const bucketsWrapper = (0, kitsui_31.Component)()
                ...
                const addFilteredItems = (bucket, items) => {
                    ...
                    for (const item of items) {
                        ...
                        if (!filterState)
                            continue;
                        const shouldShowItem = (0, kitsui_31.State)(false);
                        ...
                        kitsui_31.State.Use(details, { filterState, filterText, hasAnyItemFilteredIn, open: details.open, transitioning: details.transitioning }, (state, old) => {
                    ...
                    const shouldShowBucket = kitsui_31.State.Some(details, ...filterStates);
...
define("utility/Time", ["require", "exports", "kitsui"], function (require, exports, kitsui_32) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Time;
    (function (Time) {
        Time.state = (0, kitsui_32.State)(Date.now() / 1000);
...
define("component/view/CollectionsView", ["require", "exports", "component/core/View", "component/DisplayBar", "component/Overlay", "component/overlay/ItemOverlay", "component/view/collections/Moment", "kitsui", "kitsui/component/Slot", "Relic", "utility/Time"], function (require, exports, View_1, DisplayBar_2, Overlay_2, ItemOverlay_1, Moment_1, kitsui_33, Slot_6, Relic_5, Time_1) {
    ...
    const ActiveEvent = kitsui_33.State.Async(async () => {
    ...
    exports.default = (0, View_1.default)(async (view) => {
        ...
        const collections = (0, kitsui_33.State)(await conduit.getCollections());
        if (signal.aborted)
            return;
        ...
        (0, Slot_6.default)().appendTo(view).use({ collections, ActiveEvent }, (slot, { collections, ActiveEvent }) => {
            ...
            //#region Active Event
            if (ActiveEvent) {
                const eventWrapper = (0, kitsui_33.Component)()
                ...
                const shouldShow = kitsui_33.State.Map(momentComponent, [momentComponent.open, filterText], (open, filterText) => open || !filterText);
            ...
            for (const moment of collections.moments) {
                ...
                if (moment.moment.year !== year) {
                    ...
                    yearWrapper = !year ? undefined : (0, kitsui_33.Component)()
            ...
            function handleYearWrapperEnd() {
                ...
                const shouldShow = kitsui_33.State.Map(yearWrapper, momentVisibilityStates, (...states) => states.includes(true));
        ...
        const overlayItem = kitsui_33.State.Map(view, [view.params, collections, itemMap], (params, collections, itemMap) => {
            if (!params)
                return undefined;
...
define("component/core/Card", ["require", "exports", "component/core/Lore", "component/core/Paragraph", "kitsui"], function (require, exports, Lore_4, Paragraph_3, kitsui_34) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Lore_4 = __importDefault(Lore_4);
    Paragraph_3 = __importDefault(Paragraph_3);
    const Card = (0, kitsui_34.Component)((component) => {
        let header;
        const flush = (0, kitsui_34.State)(false);
        return component.style('card')
            .style.bind(flush, 'card--flush')
            .style.bind(kitsui_34.State.Every(component, flush, component.hoveredOrHasFocused), 'card--flush--hover')
            .extend(card => ({
            header: undefined,
            ...
            .extendJIT('header', card => header ??= (0, kitsui_34.Component)()
            .style('card-header')
            .style.bind(flush, 'card-header--flush')
            .tweak(header => {
            const text = (0, kitsui_34.Component)().style('card-header-text').appendTo(header);
...
define("component/view/SplashView", ["require", "exports", "component/core/Button", "component/core/Card", "component/core/Link", "component/core/View", "component/profile/ProfileButton", "component/WordmarkLogo", "kitsui", "model/Profile", "Relic"], function (require, exports, Button_5, Card_1, Link_2, View_2, ProfileButton_2, WordmarkLogo_2, kitsui_35, Profile_2, Relic_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    exports.default = (0, View_2.default)(async (view) => {
        ...
        const profiles = Profile_2.default.STATE.value.all;
        if (signal.aborted)
            return;
        await view.loading.finish();
        const authed = profiles.some(profile => profile.authed);
        const cards = (0, kitsui_35.Component)().style('splash-view-cards').appendTo(view.loading);
        ...
        if (profiles.length) {
            const profilesList = (0, kitsui_35.Component)()
        ...
        (0, Link_2.default)('/collections')
            .and(Button_5.default)
            .text.set(quilt => quilt['view/splash/collections-card/action/view']())
            .appendTo(collectionsCard);
    });
});
define("navigation/Routes", ["require", "exports", "component/view/CollectionsView", "component/view/SplashView", "navigation/Route", "navigation/RoutePath"], function (require, exports, CollectionsView_1, SplashView_1, Route_1, RoutePath_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("navigation/Navigate", ["require", "exports", "kitsui", "kitsui/component/Dialog", "kitsui/component/Popover", "kitsui/utility/EventManipulator", "navigation/Routes"], function (require, exports, kitsui_36, Dialog_1, Popover_2, EventManipulator_1, Routes_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    function Navigator() {
        const state = (0, kitsui_36.State)(location.href);
        let lastURL;
        const navigate = {
            state,
            event: undefined,
...
define("index", ["require", "exports", "component/Kit", "kitsui", "kitsui/utility/ActiveListener", "kitsui/utility/FocusListener", "kitsui/utility/HoverListener", "kitsui/utility/Mouse", "kitsui/utility/Viewport", "model/Profile", "navigation/Navigate", "Relic", "utility/Arrays", "utility/DevServer", "utility/Env", "utility/Text"], function (require, exports, Kit_1, kitsui_37, ActiveListener_1, FocusListener_1, HoverListener_1, Mouse_2, Viewport_1, Profile_3, Navigate_1, Relic_7, Arrays_3, DevServer_1, Env_4, Text_2) {
    ...
    async function default_1() {
        kitsui_37.Component.allowBuilding();
        Text_2.default.init();
        kitsui_37.Component.getBody().style('body');
        await Env_4.default['init']();
        void Relic_7.default.init();
        ...
        kitsui_37.Component.getBody().monitorScrollEvents();
        kitsui_37.Component.getDocument().monitorScrollEvents();
        kitsui_37.Component.getWindow().monitorScrollEvents();
        (0, Kit_1.default)();
        await (0, Navigate_1.default)().fromURL();
    }
});
define("component/core/ActionRow", ["require", "exports", "kitsui"], function (require, exports, kitsui_38) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_38.Component)(component => component.style('action-row'));
});
define("component/core/Checkbox", ["require", "exports", "kitsui"], function (require, exports, kitsui_39) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Checkbox = (0, kitsui_39.Component)('label', (component) => {
        const label = (0, kitsui_39.Component)().style('checkbox-label');
        const checked = (0, kitsui_39.State)(false);
        const input = (0, kitsui_39.Component)('input')
...
define("component/core/Checklist", ["require", "exports", "kitsui"], function (require, exports, kitsui_40) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const Checklist = (0, kitsui_40.Component)('ol', (component) => {
    ...
    const ChecklistItem = (0, kitsui_40.Component)('li', (component) => {
        const checked = (0, kitsui_40.State)(false);
        const marker = (0, kitsui_40.Component)().style('checklist-item-marker');
        const content = (0, kitsui_40.Component)().style('checklist-item-content');
        const checkIcon = (0, kitsui_40.Component)()
...
define("component/core/Footer", ["require", "exports", "kitsui"], function (require, exports, kitsui_41) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.default = (0, kitsui_41.Component)(component => component.style('footer'));
});
define("component/core/FormRow", ["require", "exports", "kitsui"], function (require, exports, kitsui_42) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const FormRow = (0, kitsui_42.Component)('label', (component) => {
        const label = (0, kitsui_42.Component)().style('form-row-label');
...
define("component/core/TextInput", ["require", "exports", "kitsui", "kitsui/utility/Applicator"], function (require, exports, kitsui_43, Applicator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    Applicator_1 = __importDefault(Applicator_1);
    const TextInput = (0, kitsui_43.Component)('input', (component) => {
        let defaultValue = '';
        const state = (0, kitsui_43.State)(defaultValue);
